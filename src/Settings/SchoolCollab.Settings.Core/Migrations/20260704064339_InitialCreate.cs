    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_coded_values", x => x.id);
                    table.ForeignKey(
                        name: "fk_coded_values_coded_values_parent_id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    global_coded_value_id = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    global_coded_value_id = table.Column<Guid>(type: "uuid", nullable: false),
                    overridden_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    overridden_description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_coded_value_attributes", x => new { x.coded_value_id, x.key });
                    table.ForeignKey(
                        name: "fk_coded_value_attributes_coded_values_coded_value_id",
                        column: x => x.coded_value_id,
                        principalTable: "coded_values",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coded_value_attributes_key_value",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coded_values_parent_id",
                table: "coded_values",
                column: "parent_id");
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "tenant_id", "global_coded_value_id", "attribute_key" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "tenant_coded_value_overrides",
                columns: new[] { "tenant_id", "global_coded_value_id" },
                unique: true);
