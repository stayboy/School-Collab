...
public sealed class ListTopicsHandler(
    StudentsDbContext db,
    HybridCache cache) : IQueryHandler<ListTopics, TopicDto[]>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await cache.GetOrCreateAsync(
            ...
            static async (state, ct) =>
            {
                ...
                return results.Select(s => new TopicDto(
