...
/// </summary>
internal sealed class TopicConfiguration : TenantEntityTypeConfigurationBase<Topic>
{
    public TopicConfiguration(Expression<Func<Guid>> tenantIdAccessor) : base(tenantIdAccessor) { }

    protected override void ConfigureTenantEntity(EntityTypeBuilder<Topic> builder)
    {
