...
public interface ITeacherRepository
{
    ...
    Task AddTopicAsync(TeacherSubject link, CancellationToken cancellationToken = default);
    Task<TeacherSubject?> GetTopicLinkAsync(Guid teacherId, Guid subjectId, CancellationToken cancellationToken = default);
    Task RemoveTopicAsync(Guid teacherId, Guid subjectId, CancellationToken cancellationToken = default);
