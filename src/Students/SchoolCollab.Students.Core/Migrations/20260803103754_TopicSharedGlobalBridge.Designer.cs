...
namespace SchoolCollab.Students.Core.Migrations
{
    ...
    [Migration("20260803103754_TopicSharedGlobalBridge")]
    partial class TopicSharedGlobalBridge
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolCollab.Students.Core.Domain.GradeSubjectAssignment", b =>
                {
                    ...
                    b.HasIndex("TenantId", "GradeLevelId", "ActivityGroupId", "TopicId", "PeriodId")
                        .IsUnique()
