...
public sealed class ListFeatureFlagsHandler(ConfigDbContext db)
...
public sealed class GetFeatureFlagHandler(ConfigDbContext db)
...
public sealed class ListAuditEntriesHandler(ConfigDbContext db)
...
public sealed class ResolveFlagsForTenantHandler(ConfigDbContext db)
